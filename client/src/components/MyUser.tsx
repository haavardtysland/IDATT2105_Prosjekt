  ...
  const onClickChangeActLvl = () => {
    ...
    if (
      ...
      axios
        ...
        .catch((error) =>
          console.log('Could not change activitylevel: ' + error.message)
        );
      setActivityLevel('');
          ...
          <div>
            <Table>
              ...
              <TableRow>
                ...
                <TableCell align="center">{currentUser.email}</TableCell>
                <TableCell align="right">
                  <Button
                    onClick={() => {
              ...
              <TableRow>
                ...
                <TableCell align="center">{currentUser.phoneNumber}</TableCell>
                <TableCell align="right">
                  <Button
                    onClick={() => {
              ...
              <TableRow>
                ...
                <TableCell align="right">
                  ...
                  >
                    <FormLabel component="label">Aktivitetsnivå</FormLabel>
                    <RadioGroup>
                      <FormControlLabel
                        control={<Radio />}
                        label="Lavt"
                ...
                <TableCell align="right">
                  ...
                  >
                    <div>
                      ...
                      <div>{noMatchPass && <h5>Passordene er ulike!</h5>}</div>
                    </div>
                  </Popup>
                </TableCell>
              </TableRow>
